...
<head>
	...
	<link href="styles/donorlogin.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css"/>
	<link rel="stylesheet" type="text/css" href="styles/donorlogin.css">
				...
				<ul>
					...
					<li><div class="dropdown">
					    ...
					    <div class="dropdown-content">
					      ...
					      <a id="active" href="Donorlogin.php">Donor Login</a>
					    </div>
					  </div></li>
					...
					<form method="POST" action="Donorlogin.php">
						...
						<div class="row">
							...
							<div id="sub" class="col-70">
								 <input type="submit" name="donorlogin" value="Log In As Donor" >
							</div>
						</div>
					</form>
				</div>
